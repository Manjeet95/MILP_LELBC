...
python Ineq_Reduction.py LELBC sbox GUROBI -
python Ineq_Reduction.py LELBC prob GUROBI -
python Ineq_Reduction.py LELBC sbox GUROBI 0 2 
python Ineq_Reduction.py LELBC sbox_2 GUROBI -
python Ineq_Reduction.py LELBC prob CPLEX 10 2
"""
...
elif (sys.argv[1] == "ESLICE"):
    s_box = ((0x6 , 0x0 , 0x8 , 0xF , 0xC , 0x3 , 0x7 , 0xD , 0xB , 0xE , 0x1 , 0x4 , 0x5 , 0x9 , 0xA, 0x2),);
elif (sys.argv[1] == "LELBC"):
    s_box = ((0xC , 0xE , 0x6 , 0xA , 0x4 , 0xF , 0x2 , 0x7 , 0x9 , 0x8 , 0x3 , 0xB , 0x0 , 0xD , 0x1, 0x5),);
    ...
    for row in range(len(DDT)):
            ...
            for col in range(len(DDT[row])):
                ...
                if(DDT[row][col]!=0):
                    ...
                    print("DDT[row][col] = ", DDT[row][col], "int_DDT_bin = ", int_DDT_bin, "or", DDT_bin)
