...
def PrintOuter(FixList,BanList):
    ...
    for i in range(0,ROUND):
        ...
        for j in range(LELBC):
            buf = ''
            if j < LELBC//2:
                buf = buf + "x" + str(i) + "_" + str(j) + " - u" + str(i) + "_" + str(j) + " = 0\n"
                opOuter.write(buf)
            else:
                opOuter.write(Constraints_XOR( "x" + str(i) + "_" + str((j + 5) % 32), "x" + str(i) + "_" + str(j), "u" + str(i) + "_" + str(j)))
        ...
        for j in range(LELBC):
            ...
            if j < LELBC//2:
                ...
                buf = buf + "x" + str(i + 1) + "_" + str(j) + " - y" + str(i) + "_" + str(j) + " = 0\n"
                opOuter.write(buf)
    ...
    for i in range(ROUND):
        ...
        for j in range(LELBC):
            ...
            if j < LELBC//2:
                ...
                opInner.write(Constraints_XOR( "x" + str(i) + "_" + str((j + 5) % 32), "x" + str(i) + "_" + str(j), "u" + str(i) + "_" + str(j)))
